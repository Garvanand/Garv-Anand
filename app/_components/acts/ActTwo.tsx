...
import { CommandPill } from '@/components/ui';
...
export function ActTwo() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen py-24 md:py-32 px-6 md:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-[var(--text)] mt-6 mb-12">
        ...
        <div className="relative">
          {/* Central trunk line */}
          <div className="absolute left-8 md:left-12 top-0 bottom-0 w-[2px] bg-[var(--border)]">
            <motion.div
          ...
          <motion.div
            ...
            className="relative pl-20 md:pl-28 pb-8"
          >
            {/* Big pulse node */}
            <div className="absolute left-[22px] md:left-[38px] top-2 z-10">
              <div className="relative">
                <div className="w-5 h-5 rounded-full bg-[#00D4FF] shadow-[0_0_20px_rgba(0,212,255,0.4)]" />
                <div className="absolute inset-0 w-5 h-5 rounded-full bg-[#00D4FF] animate-ping opacity-30" />
              </div>
            </div>

            <div className="glass-card rounded-xl p-6 border-[#00D4FF]/20">
              ...
              <h3 className="font-display text-xl md:text-2xl font-bold text-[var(--text)] mb-2">{rova.role}</h3>
          ...
          <motion.div
            ...
            className="relative pl-20 md:pl-28 pb-8"
          >
            <div className="absolute left-[25px] md:left-[41px] top-3 z-10">
          ...
          >
            <div className="absolute left-[26px] md:left-[42px] top-3 z-10">
