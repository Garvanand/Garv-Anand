...
import { TechBadge, GlowButton, SectionReveal } from "@/components/ui"
import { Navigation } from "../_components/Navigation"
import { LiveInferenceLab } from "../_components/LiveInferenceLab"

const getProjectStatus = (id: string) => {
  if (id === 'proj-elderai') return 'Production';
  if (id === 'proj-parkinsons' || id === 'proj-ser') return 'Research';
