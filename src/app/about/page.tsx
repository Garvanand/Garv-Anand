...
import { SectionReveal, TechBadge } from "@/components/shared/ui"
        ...
        <SectionReveal delay={0.4}>
          <div className="mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {intellectData.achievements.map((ach) => (
                <div key={ach.id} className="glass-card p-6 rounded-xl border-white/5 hover:border-[#00D4FF]/30 transition-colors group">
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="font-display text-lg font-bold text-white group-hover:text-[#00D4FF] transition-colors">
                      {ach.title}
                    </h4>
                    {ach.verifiable && (
                      <span className="text-[10px] font-mono text-[#00FF87] bg-[#00FF87]/10 px-2 py-0.5 rounded-full uppercase tracking-wider">
                        Verified
                      </span>
                    )}
                  </div>
                  ...
                  {ach.link && (
                    <a 
                      ...
                      className="inline-flex items-center gap-2 text-[10px] font-mono text-[#00D4FF] hover:underline"
                    >
                      View Credential
