...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white flex flex-col items-center justify-center relative overflow-hidden selection:bg-[#00D4FF]/30">
      ...
      {/* The "Neural Bot" - Interactable Mascot */}
      <motion.div
        style={{
          x: botX,
          y: botY,
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          <h1 className="font-display text-[12vw] md:text-[8vw] font-black tracking-tighter leading-none mb-4 bg-gradient-to-b from-white to-white/20 bg-clip-text text-transparent">
            404
          </h1>
          
          <div className="inline-block bg-[#00D4FF]/10 border border-[#00D4FF]/20 px-4 py-2 rounded-full mb-8">
            <span className="font-mono text-xs text-[#00D4FF] uppercase tracking-[0.2em]">
              Error: Manifold Not Found
            </span>
          </div>

          <h2 className="font-display text-2xl md:text-3xl font-bold mb-6 max-w-2xl mx-auto text-[#F0F0FF]">
            Looks like this page drifted into a <span className="text-[#00D4FF]">non-invertible matrix.</span>
          </h2>

          <p className="font-mono text-sm text-[#8B8BA7] mb-12 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Link 
              href="/"
              className="group relative px-8 py-4 bg-[#00D4FF] text-black font-display font-bold uppercase tracking-widest rounded-xl hover:bg-white transition-all duration-300"
            >
            ...
            <button 
              ...
              className="px-8 py-4 border border-white/10 text-white font-display font-bold uppercase tracking-widest rounded-xl hover:bg-white/5 transition-all"
            >
              Retry Sync
            </button>
          </div>
      ...
      <div className="absolute bottom-10 left-0 right-0 text-center">
        <p className="font-mono text-[10px] text-[#55556A] uppercase tracking-[0.5em]">
